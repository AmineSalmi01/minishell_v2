...
SRC = 	parse_src/add_spaces.c parse_src/file_utils.c parse_src/free_utils.c parse_src/get_env_utils.c parse_src/get_env_special_case.c \
		...
		execution_src/execution.c execution_src/handle_signal.c execution_src/heredoc_handler.c execution_src/heredoc_utils.c execution_src/redirection_handler.c parse_src/priiint.c
...
$(NAME) : $(LIBFT) $(OBJS) includes/minishell.h
	$(CC) $(CFLAGS) -L ~/goinfre/homebrew/opt/readline/lib/ $(OBJS) $(LIBFT) -o $@ -lreadline
